...
const { DB_URI, JWT_SECRET, JWT_REFRESH_SECRET, NODE_ENV, PORT } = process.env
...
if(!JWT_REFRESH_SECRET) throw new Error('JWT_REFRESH_SECRET env variable is not defined')
if(!NODE_ENV) throw new Error('NODE_ENV env variable is not defined')
if(!PORT) throw new Error('PORT env variable is not defined')

module.exports = { DB_URI, JWT_SECRET, JWT_REFRESH_SECRET, NODE_ENV, PORT}