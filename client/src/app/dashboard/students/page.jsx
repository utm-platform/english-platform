    ...
    <main>
      <div className='flex flex-row bg-neutral-100 w-screen h-full'>
        ...
        <div className='bg-aqua w-full h-fit pl-[15em]'>
          <div className='bg-aqua w-full h-1/2'></div>
          <div></div>
          <Header />
          <div className='justify-evenly flex flex-row pb-8 pt-5 flex-wrap p-5'>
            <div className='w-full px-10 flex'>
              <h1 className='text-4xl font-bold text-white mr-10'>Student info</h1>
              ...
              <div className='w-2/4 relative'>
                <button
                  ...
                  <span className='flex items-center'>
                    <span className='ml-3 block truncate'>Filter...</span>
                  </span>
          ...
          <div className='bg-white p-5 h-fit flex justify-evenly'>
            <div className='bg-[#FFF] w-11/12 mb-6 relative rounded-3xl p-7 drop-shadow-lg flex items-center'>
              <table className='w-full border-aqua border-2'>
                <tr className='text-[#FFF] bg-aqua'>
                  <th>First Name</th>
                  <th>Last Name</th>
                  <th>English Level</th>
                  <th>Email</th>
