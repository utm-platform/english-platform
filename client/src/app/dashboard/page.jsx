      ...
      <div className='flex flex-row bg-neutral-100 w-screen h-full'>
        ...
        <div className='bg-aqua w-full h-fit pl-[15em]'>
          ...
          <div className='justify-evenly flex flex-row pb-16 pt-10 flex-wrap p-5'>
            <WhiteBox txt='Teachers' icon={<Icon_Teacher className='px-1.5' size={'4em'} />} />
            <WhiteBox txt='Groups' icon={<Icon_Group className='px-1.5' size={'4em'} />} />
            <WhiteBox txt='Students' icon={<Icon_Student className='px-3' size={'4em'} />} />
          </div>
